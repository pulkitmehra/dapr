...
func TestInitCustomComponent(t *testing.T) {
	...
	t.Run("custom component is registered", func(t *testing.T) {
		...
		rt.customComponentRegistry.Register(
			custom_loader.New("encryptdecrypt", func() custom_loader.CustomComponent {
		...
		//expected metadata
		expectedMetadata := custom_loader.Metadata{
...
// Init is a mock initialization method
func (m *mockcustom) Init(metadata custom_loader.Metadata) error {
